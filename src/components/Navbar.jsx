...
const Navbar = () => {
  return (
    <div className="py-3 px-8 grid grid-cols-3 gap-x-4 border border-solid bg-[#FFF] border-[#D9D9D9]">
      <div className="flex items-center gap-x-4 text-[15px] leading-[22px] text-xs">
        <p className="text-[15px] leading-[22px] text-[#1A181E]">Payments</p>
        <div className="flex gap-x-[6px] items-center">
          <svg
            ...
            fill="none"
          >
            <g clip-path="url(#clip0_61784_2522)">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
      ...
      <div className="py-[9px] px-4 gap-x-[8px] flex items-center  bg-[#F2F2F2] rounded-[6px]">
        <div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            ...
            fill="none"
          >
            <g clip-path="url(#clip0_61784_2526)">
              <path
        ...
        <input
          type="text"
          className="outline-none bg-transparent w-full text-[15px] leading-[22px] text-[#808080]"
      ...
      <div className="flex items-center justify-end gap-3">
        ...
        <div className="cursor-pointer">
          <svg
            ...
            fill="none"
          >
            <g clip-path="url(#clip0_61784_2537)">
